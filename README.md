...
End  to End Azure dtata engineering Pipeline project by using key services of Azure like Azure Data Factory, Azure Databricks, Azure Synapse Analytics and Power BI. The medallion architecture is implmented throughout the data flow for better control over data and bronze, silver and gold layers are created. Dynamic pipelines in ADF are created tol extract multiple files from source using a json script to experience real time scenario followed in production.  
